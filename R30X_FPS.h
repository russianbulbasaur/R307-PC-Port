...
//class R30X_FPS {
  //public:
   ...
   // R30X_FPS (uint32_t password = FPS_DEFAULT_PASSWORD, uint32_t address = FPS_DEFAULT_ADDRESS);
 uint32_t password = FPS_DEFAULT_PASSWORD;
 uint32_t address = FPS_DEFAULT_ADDRESS;
 int fd;
  //common parameters
